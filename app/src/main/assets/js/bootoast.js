...
(function($, window, document, undefined) {
    ...
    function BootstrapNotify(options) {
        ...
        if (options !== undefined) {
            ...
            // Checa se foi passada uma mensagem flat ou se hÃ¡ opÃ§Ãµes.
            ...
            // Define uma posiÃ§Ã£o suportada para o .alert
            if (this.positionSupported[this.settings.position] === undefined) {
                // Tenta encontrar um sinÃ´nimo
            ...
            // Define se o novo .alert deve ser inserido por primeiro ou Ãºltimo no container.
            ...
            // Checa se jÃ¡ tem container, se nÃ£o cria um.
            ...
            // Se o .alert tem tempo de expiraÃ§Ã£o
